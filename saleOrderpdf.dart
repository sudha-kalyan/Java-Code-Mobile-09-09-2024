...
class SaleOrderPdfPage extends StatefulWidget {
  String? customer = null;
  DateTime date = DateTime.now();
  late Future getCustomrs_obj = getCustomrs();
  late Future getSOSs = getSOS(customer.toString(), date,orderNo.toString());

  String? orderNo;


  @override
  State<SaleOrderPdfPage> createState() => _SaleOrderPdfPageState();
}

class _SaleOrderPdfPageState extends State<SaleOrderPdfPage> {
  ...
  OnDateChange(val) {
    setState(() {
      widget.date = val;
      widget.getSOSs = getSOS(
          widget.customer.toString(), widget.date,widget.orderNo.toString());
    });
  }
  ...
  Future<File?> fetchPDF(context) async {
    ...
    Map<String, String> body = {
      'date': date,
      'suplCode': widget.customer.toString(),
    ...
    if (response.body.isNotEmpty) {
      return _storeFilePDF(
          date.toString() + widget.customer.toString() + '.pdf',
          response.bodyBytes);
    } else {
      return null;
    }
    ...
    return SingleChildScrollView(
      ...
      child: Container(
          child: Column(children: [
            AppBarCustom("SaleOrderPdf", Size(double.infinity, 50), () {}),
            Container(
